...
if ( is_page() || is_single() ):
	...
	if( have_rows('flexible_content') ):
		...
		while ( have_rows('flexible_content') ) : the_row();
			...
			if( get_row_layout() == 'header_style_1' ):
				echo '<div class="header_style_1 clear"><h3>';
				the_sub_field('header_1');
				echo '</h3></div>';
			endif;
			
			if( get_row_layout() == 'header_style_2' ):
			...
			if( get_row_layout() == '2_column_reverse' ):
			...
			if( get_row_layout() == '4_column' ):
				get_template_part('partials/4-column', '4-column');
			endif;
			
			if( get_row_layout() == 'section_divider' ):
				if( get_sub_field('divider_type') == 'small-space' ): 
					echo '<span class="small-space"></span>';
				endif;
			endif;
			
			if( get_row_layout() == 'section_divider' ):
				if( get_sub_field('divider_type') == 'medium-space' ): 
					echo '<span class="medium-space"></span>';
				endif;
			endif;
			
			if( get_row_layout() == 'section_divider' ):
				if( get_sub_field('divider_type') == 'large-space' ): 
					echo '<span class="large-space"></span>';
				endif;
			endif;
			...
			if( get_row_layout() == 'multiple_testimonials' ):
			...
			if( get_row_layout() == 'featured_snippets_2_column' ):
